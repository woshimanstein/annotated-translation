...
class Encoder(nn.Module):
    def __init__(self, vocab_size=50265, embed_size=1024, embedding=None, hidden_size=1024, num_layers=4,
                 dropout=0.1, padding_token_id=1, source_tagger=None):
    ...
    def forward(self, x):
        ...
        # embedding layer
        embed = self.dropout(self.embedding(x) + self.embedding_tag(tag_idx))  # embed.shape = (max_seq_len, batch_size, embed_size)
        # lstm layer
