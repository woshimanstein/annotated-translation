...
MODEL_NAME = f'pointer_generator_{BATCH_SIZE}'
log_file = open(os.path.join('model_weights', f'{MODEL_NAME}.log'), 'w')
print(f"training pointer generator with batch size {BATCH_SIZE} for {NUM_EPOCH} epochs")

# model setup
tokenizer = BartTokenizer.from_pretrained('facebook/bart-base')
model = PointerGenerator(embed_size=EMBEDDING_DIM,
